...
namespace FI.AtividadeEntrevista.DAL.Beneficiario
{
    ...
    internal class DaoBeneficiario : AcessoDados
    {
        ...
        internal DML.Beneficiario ConsultarExistenciaParaCliente(long ClienteId, string cpf)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
            ...
            DataSet ds = base.Consultar("FI_SP_ConsExisteBeneficiarioCliente", parametros);
            List<DML.Beneficiario> cli = Converter(ds);
